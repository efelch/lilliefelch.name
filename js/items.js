const ITEM_TYPES = [
    ...
    { id: 'royal_mirror', name: 'Hand Mirror', icon: 'game-icons:hand-mirror', color: '#1E88E5' },
    ...
    { id: 'toy_bear', name: 'Teddy Bear', icon: 'game-icons:teddy-bear', color: '#795548' },
    ...
    { id: 'toy_marionette', name: 'Marionette', icon: 'game-icons:marionette', color: '#A1887F' },
    { id: 'toy_mask', name: 'Masquerade Mask', icon: 'game-icons:masquerade', color: '#4527A0' },
    ...
    { id: 'beauty_fan', name: 'Lace Fan', icon: 'game-icons:hand-fan', color: '#BF360C' },
    ...
    { id: 'beauty_brooch', name: 'Flower Brooch', icon: 'game-icons:flower-gem', color: '#E91E63' },
    ...
    { id: 'tea_goblet', name: 'Crystal Goblet', icon: 'game-icons:goblet', color: '#0288D1' },
    ...
    { id: 'scroll_royal', name: 'Royal Decree', icon: 'game-icons:sealed-scroll', color: '#A1887F' },
    ...
    { id: 'nature_tulip', name: 'Pink Tulip', icon: 'game-icons:tulip', color: '#EC407A' },
    ...
    // Miscellaneous
    { id: 'misc_key', name: 'Golden Key', icon: 'game-icons:old-key', color: '#FBC02D' },
